...
pub struct CodePathState {
    ...
    pub fork_context: Id<ForkContext>,
...
impl CodePathState {
    ...
    pub fn make_optional_node(&mut self, arena: &mut Arena<ForkContext>) {
    ...
    pub fn push_try_context(&mut self, arena: &mut Arena<ForkContext>, has_finalizer: bool) {
