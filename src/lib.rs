...
use rules::{
    default_case_rule, for_direction_rule, max_nested_callbacks_rule, max_params_rule,
    ...
    no_dupe_else_if_rule, no_dupe_keys_rule, no_duplicate_case_rule, no_eq_null_rule,
