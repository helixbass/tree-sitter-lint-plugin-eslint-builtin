...
#[test]
fn test_object_pattern_in_assignment_expression() {
    tracing_subscribe();
    ...
    let implicit_left = scope.implicit().left;
    assert_that(&implicit_left).has_length(4);
    assert_that(&&*implicit_left[0].identifier().text(&scope_manager)).is_equal_to("shorthand");
    assert_that(&&*implicit_left[1].identifier().text(&scope_manager)).is_equal_to("value");
    assert_that(&&*implicit_left[2].identifier().text(&scope_manager)).is_equal_to("world");
    assert_that(&&*implicit_left[3].identifier().text(&scope_manager)).is_equal_to("object");
...
#[test]
fn test_complex_pattern_in_assignment_expression() {
    tracing_subscribe();
    ...
    assert_that!(&scope.references().collect_vec()).is_empty();
    let implicit_left = scope.implicit().left;
    assert_that(&implicit_left).has_length(8);
    assert_that(&&*implicit_left[0].identifier().text(&scope_manager)).is_equal_to("shorthand");
    assert_that(&&*implicit_left[1].identifier().text(&scope_manager)).is_equal_to("a");
    assert_that(&&*implicit_left[2].identifier().text(&scope_manager)).is_equal_to("b");
    assert_that(&&*implicit_left[3].identifier().text(&scope_manager)).is_equal_to("c");
    assert_that(&&*implicit_left[4].identifier().text(&scope_manager)).is_equal_to("d");
    assert_that(&&*implicit_left[5].identifier().text(&scope_manager)).is_equal_to("e");
    assert_that(&&*implicit_left[6].identifier().text(&scope_manager)).is_equal_to("world");
    assert_that(&&*implicit_left[7].identifier().text(&scope_manager)).is_equal_to("object");
...
#[test]
fn test_array_pattern_in_parameters() {
    tracing_subscribe();
    ...
    assert_that(&&*references[0].identifier().text(&scope_manager)).is_equal_to("array");
    let implicit_left = scope.implicit().left;
    assert_that(&implicit_left).has_length(1);
    assert_that(&&*implicit_left[0].identifier().text(&scope_manager)).is_equal_to("array");
...
#[test]
fn test_spread_element_in_parameters() {
    tracing_subscribe();
    ...
    assert_that!(&scope.type_()).is_equal_to(ScopeType::Function);
    let variables = scope.variables().collect_vec();
    assert_that!(&variables).has_length(5);
    assert_that!(&variables[0].name()).is_equal_to("arguments");
    assert_that!(&variables[1].name()).is_equal_to("a");
    assert_that!(&variables[2].name()).is_equal_to("b");
    assert_that!(&variables[3].name()).is_equal_to("rest");
    assert_that!(&variables[3].defs().next().unwrap().rest()).is_true();
    assert_that!(&variables[4].name()).is_equal_to("rest2");
    assert_that!(&variables[4].defs().next().unwrap().rest()).is_true();
    assert_that!(&scope.references().collect_vec()).is_empty();
}

#[test]
fn test_object_pattern_in_parameters() {
    tracing_subscribe();
    ...
    let references = scope.references().collect_vec();
    assert_that!(&references).has_length(1);
    assert_that(&&*references[0].identifier().text(&scope_manager)).is_equal_to("object");
    let implicit_left = scope.implicit().left;
    assert_that(&implicit_left).has_length(1);
    assert_that(&&*implicit_left[0].identifier().text(&scope_manager)).is_equal_to("object");
...
#[test]
fn test_complex_pattern_in_parameters() {
    tracing_subscribe();
...
#[test]
fn test_default_values_and_patterns_in_var() {
    tracing_subscribe();
...
#[test]
fn test_default_values_containing_references_and_patterns_in_var() {
    tracing_subscribe();
    ...
    assert_that(&&*references[4].identifier().text(&scope_manager)).is_equal_to("d");
    assert_that(&&*references[5].identifier().text(&scope_manager)).is_equal_to("e");
    assert_that(&&*references[6].identifier().text(&scope_manager)).is_equal_to("array");
}

#[test]
fn test_nested_default_values_containing_references_and_patterns_in_var() {
    tracing_subscribe();
    ...
    assert_that!(&variables[4].name()).is_equal_to("d");
    let references = scope.references().collect_vec();
    assert_that!(&references).has_length(10);
    assert_that(&&*references[0].identifier().text(&scope_manager)).is_equal_to("a");
    assert_that(&&*references[1].identifier().text(&scope_manager)).is_equal_to("b");
    assert_that(&&*references[2].identifier().text(&scope_manager)).is_equal_to("c");
    assert_that(&&*references[3].identifier().text(&scope_manager)).is_equal_to("c");
    assert_that(&&*references[4].identifier().text(&scope_manager)).is_equal_to("d");
    assert_that(&&*references[5].identifier().text(&scope_manager)).is_equal_to("d");
    assert_that(&&*references[6].identifier().text(&scope_manager)).is_equal_to("d");
    assert_that(&&*references[7].identifier().text(&scope_manager)).is_equal_to("e");
    assert_that(&&*references[8].identifier().text(&scope_manager)).is_equal_to("f");
    assert_that(&&*references[9].identifier().text(&scope_manager)).is_equal_to("array");
}
