...
use rules::{
    ...
    no_new_native_nonconstructor_rule, no_new_object_rule, no_new_rule, no_new_wrappers_rule,
    ...
    no_undef_rule, no_unneeded_ternary_rule, no_unreachable_loop_rule, no_unreachable_rule,
