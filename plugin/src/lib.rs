...
use rules::{
    ...
    no_const_assign_rule, no_constructor_return_rule, no_debugger_rule, no_dupe_class_members_rule,
    ...
    no_fallthrough_rule, no_func_assign_rule, no_import_assign_rule, no_labels_rule,
    no_lonely_if_rule, no_mixed_operators_rule, no_multi_assign_rule, no_multi_str_rule,
    no_negated_condition_rule, no_nested_ternary_rule, no_new_object_rule, no_new_rule,
    ...
    no_this_before_super_rule, no_throw_literal_rule, no_unneeded_ternary_rule,
