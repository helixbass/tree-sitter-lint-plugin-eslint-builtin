...
use rules::{
    ...
    no_dupe_keys_rule, no_duplicate_case_rule, no_duplicate_imports_rule, no_empty_pattern_rule,
    no_eq_null_rule, no_ex_assign_rule, no_extra_bind_rule, no_extra_label_rule,
    no_fallthrough_rule, no_func_assign_rule, no_import_assign_rule, no_inner_declarations_rule,
    no_labels_rule, no_lonely_if_rule, no_loss_of_precision_rule, no_mixed_operators_rule,
    no_multi_assign_rule, no_multi_str_rule, no_negated_condition_rule, no_nested_ternary_rule,
    no_new_object_rule, no_new_rule, no_new_wrappers_rule, no_octal_escape_rule, no_octal_rule,
