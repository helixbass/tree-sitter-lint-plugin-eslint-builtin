...
use rules::{
    ...
    no_compare_neg_zero_rule, no_cond_assign_rule, no_constructor_return_rule, no_debugger_rule,
    no_dupe_class_members_rule, no_dupe_else_if_rule, no_dupe_keys_rule, no_duplicate_case_rule,
    no_empty_pattern_rule, no_eq_null_rule, no_extra_bind_rule, no_extra_label_rule,
    no_fallthrough_rule, no_labels_rule, no_lonely_if_rule, no_mixed_operators_rule,
