...
use rules::{
    ...
    no_multi_str_rule, no_negated_condition_rule, no_nested_ternary_rule, no_new_object_rule,
    no_new_rule, no_new_wrappers_rule, no_octal_escape_rule, no_octal_rule, no_param_reassign_rule,
