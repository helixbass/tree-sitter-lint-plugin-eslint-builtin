...
use rules::{
    complexity_rule, consistent_return_rule, constructor_super_rule, default_case_last_rule,
    default_case_rule, for_direction_rule, getter_return_rule, max_nested_callbacks_rule,
