...
use rules::{
    ...
    prefer_object_has_own_rule, prefer_template_rule, radix_rule, require_await_rule,
    require_yield_rule, sort_imports_rule, sort_keys_rule, sort_vars_rule, space_unary_ops_rule,
